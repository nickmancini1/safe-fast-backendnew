...
- **Latest observed local HEAD / origin/main:** `0d3d816 Add shadow review export bundle review package validator`
...
- **Current objective:** shadow review/export bundle review-package validator closeout review using local/in-memory evidence only
