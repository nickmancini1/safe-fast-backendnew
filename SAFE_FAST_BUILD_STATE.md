...
- **Latest observed local HEAD / origin/main:** `53bb2b9 Add shadow review export shape validator`
...
- **Current objective:** shadow review export-shape validator closeout review using local/in-memory evidence only
