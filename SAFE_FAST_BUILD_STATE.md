...
- **Latest observed local HEAD / origin/main:** `2a8fdc3 Add shadow review export bundle review package final boundary sweep`
...
- **Current objective:** shadow review/export bundle review-package final boundary sweep closeout review using local/in-memory evidence only
