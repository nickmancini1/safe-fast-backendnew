# SAFE-FAST Day 50 Positive-Entry Selected-Contract Blocker Closeout
...
1. `SAFE_FAST_DAY50_EVIDENCE_BACKED_POSITIVE_ENTRY_TESTING_BATCH_RESULT.md`
2. `historical_signal_replay/results/day50_evidence_backed_positive_entry_testing_batch.json`
3. `SAFE_FAST_DAY50_ACCEPTED_SETUP_EVIDENCE_REPLAY_AFTER_INTAKE_CLOSEOUT_RESULT.md`
4. `historical_signal_replay/results/day50_accepted_setup_evidence_replay_after_intake_closeout.json`
5. `SAFE_FAST_DAY48_POSITIVE_TRADE_CAPTURE_AND_MISS_ANALYSIS_RESULT.md`
6. `historical_signal_replay/results/day48_positive_trade_capture_funnel.json`
7. `SAFE_FAST_PROJECT_DASHBOARD.md`
8. `SAFE_FAST_PROJECT_RULE_INDEX.md`
9. `SAFE_FAST_DATA_SOURCE_REGISTRY.md`

Expected branch: `main`.

If local Git or canonical control files disagree with the evidence-backed positive-entry batch result, stop and report the exact conflict.

## Objective

Close out the selected-contract blocker surface from the evidence-backed positive-entry batch using existing local evidence and regression controls only.
...
- Name exact selected-contract blockers by field/source/dataset/schema/API/calculator/timestamp window when a candidate cannot advance.
