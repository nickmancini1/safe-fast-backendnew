...
checklist = ns["_build_checklist_block"](
    ...
    structure_context={
        ...
        # Extension is elevated, but not a hard blocker.
        "extension_state": "caution",
        "extension_blocks_now": False,
        "extension_soft_flag": True,
        "extension_material": True,
        "pct_from_ema": 0.55,
        "atr_multiple_from_ema": 1.10,
    },
...
if "early_enough" in failed:
    print("EXTENSION CAUTION CONTRACT FAIL: soft extension caution is still a hard blocker")
    raise SystemExit(2)

if "extension_caution" not in cautions:
    print("EXTENSION CAUTION CONTRACT FAIL: extension caution is not surfaced")
    raise SystemExit(2)

print("EXTENSION CAUTION CONTRACT PASS")
