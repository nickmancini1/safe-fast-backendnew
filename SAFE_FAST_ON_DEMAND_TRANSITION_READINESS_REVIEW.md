...
The stale `SAFE_FAST_PROJECT_MASTER_HANDOFF.md` latest-completed-commit reference has been cleaned up to `c4c3926 Add multi-fixture signal replay support`.
