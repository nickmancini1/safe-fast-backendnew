...
| QQQ gap-context calculator evidence use | pending validation | The calculator has focused tests, but its outputs have not been filled into evidence rows and do not authorize backtest, trade selection, P&L, proof, profitability, or readiness. |
